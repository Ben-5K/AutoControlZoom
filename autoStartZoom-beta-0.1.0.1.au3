...
# to activate this part just delete the Lines with #comments-start and #comments-end
#comments-start
Func checktime()
	...
	ElseIf $wday = "Saturday" Then
		...
		Endif
	Else
		SplashTextOn("Info", "Wrong Time for Zoom autostart", 300, 50, -1, -1, $DLG_TEXTLEFT, "")
			Sleep(5000)
			SplashOff()
		Exit 0
	EndIf
...
# delete this part here, if you don't need to Shutdown the PC automatically
# delete all lines until > END OF DELETE PART 1
	#auto off aktivieren
	...
	Sleep(1000)
# END OF DELETE PART 2


# delete this part here, if you don't need to Shutdown the PC automatically
# delete all lines until > END OF DELETE PART 3
